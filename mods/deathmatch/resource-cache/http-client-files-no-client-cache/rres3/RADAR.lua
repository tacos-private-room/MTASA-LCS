...
function drawBlips()
	for k,v in ipairs(getElementsByType("blip")) do
		if not getElementData(v,"DoNotDrawOnMaximap") then
			...
			dxDrawImage(x-halfsize,y-halfsize,size,size,"IMAGES/"..icon..".png",0,0,0,tocolor(r,g,b,a),false)
		end
	end
end
...
function drawLocalPlayerArrow()
	...
	dxDrawImage(mapX-8,mapY-8,16,16,"IMAGES/2.png",(-r)%360,0,0,normalColor,false)
end
...
--Disable Standart Radar

function RadarON()
toggleControl("radar",false)
end
addEventHandler ( "onClientRender", root, RadarON )