...
function toggleChatBox(state)
	...
	if not chatbox.shown and chatbox.isChatboxAllowed then
		...
		bindKey("g", "down", toggleInput, "Global")	
		bindKey("t", "down", toggleInput, "Local")	
		bindKey("y", "down", toggleInput, "Team")	
		bindKey("x", "down", toggleInput, "Group")	
	...
	elseif chatbox.shown then
		...
		unbindKey("g", "down", toggleInput)	
		unbindKey("t", "down", toggleInput)	
		unbindKey("y", "down", toggleInput)
		unbindKey("x", "down", toggleInput)	
...
function showChatBox()
	...
	for i, tab in ipairs(chatbox.tabs) do
		...
		if i == chatbox.selectedTabIndex then
			...
			dxDrawText(tab.name, chatbox.tabX+1, chatbox.posY-chatbox.edge-chatbox.tabHeight+1, chatbox.tabX+chatbox.tabWidth+1, chatbox.posY+1, tocolor(0,0,0,255), chatbox.fontSizeX, chatbox.fontSizeY, chatbox.font, "center", "center", false, false, chatbox.postGUI, true) 
			...
			dxDrawRectangle(chatbox.tabX, chatbox.posY-chatbox.edge, chatbox.tabWidth, chatbox.edge, tocolor(0,0,0,255), chatbox.postGUI)
			dxDrawText(tab.name, chatbox.tabX+1, chatbox.posY-chatbox.edge-chatbox.tabHeight+1, chatbox.tabX+chatbox.tabWidth+1, chatbox.posY+1, tocolor(0,0,0,255), chatbox.fontSizeX, chatbox.fontSizeY, chatbox.font, "center", "center", false, true, chatbox.postGUI, true) 
		...
		dxDrawRectangle(chatbox.tabX+chatbox.tabWidth, chatbox.posY-chatbox.edge, chatbox.tabOffset, chatbox.edge, tocolor(0,0,0,255), chatbox.postGUI)
		
		dxDrawRectangle(chatbox.tabX, chatbox.posY-chatbox.edge-chatbox.tabHeight, chatbox.tabWidth, chatbox.edge, tocolor(0,0,0,255), chatbox.postGUI)

		dxDrawRectangle(chatbox.tabX, chatbox.posY-chatbox.edge-chatbox.tabHeight, chatbox.edge, chatbox.tabHeight+chatbox.edge, tocolor(0,0,0,255), chatbox.postGUI)

		dxDrawRectangle(chatbox.tabX+chatbox.tabWidth-chatbox.edge, chatbox.posY-chatbox.edge-chatbox.tabHeight, chatbox.edge, chatbox.tabHeight+chatbox.edge, tocolor(0,0,0,255), chatbox.postGUI)
	...
	--Background
	dxDrawRectangle(chatbox.tabX, chatbox.posY-chatbox.edge, chatbox.posX+chatbox.width-chatbox.tabX+chatbox.edge, chatbox.edge, tocolor(0,0,0,255), chatbox.postGUI)
	...
	if chatbox.fadeOut == 0 or (chatbox.fadeOut == 1 and chatbox.inputShown) then 
		...
		dxDrawRectangle(chatbox.posX, chatbox.posY-chatbox.edge, chatbox.edge, chatbox.height+2*chatbox.edge, tocolor(0,0,0,255), chatbox.postGUI)
		dxDrawRectangle(chatbox.posX, chatbox.posY+chatbox.height, chatbox.width, chatbox.edge, tocolor(0,0,0,255), chatbox.postGUI)
		dxDrawRectangle(chatbox.posX+chatbox.width, chatbox.posY-chatbox.edge, chatbox.edge, chatbox.height+2*chatbox.edge, tocolor(0,0,0,255), chatbox.postGUI)
	...
	--Team Tab
	if getPlayerTeam(localPlayer) and not getTabByName("Team") then
		addTab("Team", "#ffaa00")
	elseif not getPlayerTeam(localPlayer) and getTabByName("Team") then
		removeTab("Team")
	end
	
	
	--Group Tab
	if getElementData(localPlayer, "chatgroup") and not getTabByName("Group") then
		addTab("Group", "#00ff00")
	elseif not getElementData(localPlayer, "chatgroup") and getTabByName("Group") then
		removeTab("Group")
	end
...
function buttonHandling(button, press)
	...
	if tonumber(button) then
		...
		if tonumber(button) <= 0 or tonumber(button) > #chatbox.tabs then return end
		
		if chatbox.inputShown or guiGetInputEnabled() or isConsoleActive() then return end
		
		chatbox.selectedTabIndex = tonumber(button)
		chatbox.scroll = 0
		return
