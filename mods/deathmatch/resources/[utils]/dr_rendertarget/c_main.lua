...
shaderSettings = {distFade = {150, 120}}
isSmootherNormals = false -- smooth generated normals a bit
...
function startDR()
	...
	if isPrep4Primitives then
		if isSmootherNormals then
			shaderMaterial.SHPrepRTs = DxShader( "fx/primitive3D_prepRTs_nor.fx" )
		else
		...
		if isSmootherNormals then
			shaderMaterial.SHPrepRTs = DxShader( "fx/material3D_prepRTs_nor.fx" )
		else
