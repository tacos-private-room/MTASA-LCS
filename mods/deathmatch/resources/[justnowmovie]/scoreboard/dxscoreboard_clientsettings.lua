...
function createScoreboardSettingsWindow( posX, posY )
	if not windowSettings then
		windowSettings = guiCreateWindow( posX, posY, 323, 350, "玩家列表设置", false )
		guiSetText( windowSettings, "玩家列表设置" )
		guiWindowSetSizable( windowSettings, false )
		
		labelUseAnimation = guiCreateLabel( 10, 26, 64, 15, "动画效果:", false, windowSettings )
		guiSetFont( labelUseAnimation, "default-small" )
		checkAnimationYes = guiCreateCheckBox( 101, 26, 42, 14, "开启", false, false, windowSettings )
		checkAnimationNo = guiCreateCheckBox( 167, 26, 42, 14, "关闭", false, false, windowSettings )
		
		labelMode = guiCreateLabel( 10, 43, 64, 15, "模式:", false, windowSettings )
		guiSetFont( labelMode, "default-small" )
		checkModeHolding = guiCreateCheckBox( 101, 43, 64, 14, "长按式", false, false, windowSettings )
		checkModeToggled = guiCreateCheckBox( 167, 43, 64, 14, "开关式", false, false, windowSettings )
		
		labelShowInfoOf = guiCreateLabel( 10, 60, 64, 15, "显示信息:", false, windowSettings )
		guiSetFont( labelShowInfoOf, "default-small" )
		checkServerInfoServer = guiCreateCheckBox( 101, 60, 64, 14, "服务器名称", false, false, windowSettings )
		checkServerInfoGamemode = guiCreateCheckBox( 167, 60, 84, 14, "地图模式", false, false, windowSettings )
		
		labelShowTeams = guiCreateLabel( 10, 77, 64, 15, "显示团队:", false, windowSettings )
		guiSetFont( labelShowTeams, "default-small" )
		checkShowTeamsYes = guiCreateCheckBox( 101, 77, 64, 14, "开启", false, false, windowSettings )
		checkShowTeamsNo = guiCreateCheckBox( 167, 77, 84, 14, "关闭", false, false, windowSettings )
		
		labelUseColors = guiCreateLabel( 10, 94, 64, 15, "使用玩家颜色:", false, windowSettings )
		guiSetFont( labelUseColors, "default-small" )
		checkUseColorsYes = guiCreateCheckBox( 101, 94, 64, 14, "开始", false, false, windowSettings )
		checkUseColorsNo = guiCreateCheckBox( 167, 94, 84, 14, "关闭", false, false, windowSettings )
		
		labelDrawSpeed = guiCreateLabel( 10, 111, 64, 15, "渲染速度:", false, windowSettings )
		guiSetFont( labelDrawSpeed, "default-small" )
		scrollDrawSpeed = guiCreateScrollBar( 101, 111, 172, 14, true, false, windowSettings )
		
		labelScale = guiCreateLabel( 10, 128, 64, 15, "界面比例:", false, windowSettings )
		guiSetFont( labelScale, "default-small" )
		scrollScale = guiCreateScrollBar( 101, 128, 172, 14, true, false, windowSettings )
		
		labelFonts = guiCreateLabel( 10, 145, 64, 15, "字体:", false, windowSettings )
		...
		labelBackgroundColor = guiCreateLabel( 10, 179, 74, 12, "背景颜色:", false, windowSettings)
		guiSetFont( labelBackgroundColor, "default-small" )
		buttonChangeBackgroundColor = guiCreateButton( 187, 179, 87, 14, "修改", false, windowSettings )
		guiSetFont( buttonChangeBackgroundColor, "default-bold-small" )
		
		labelSelectionColor = guiCreateLabel( 10, 196, 74, 12, "选中自己颜色:", false, windowSettings )
		guiSetFont( labelSelectionColor, "default-small" )
		buttonChangeSelectionColor = guiCreateButton( 187, 196, 87, 14, "修改", false, windowSettings )
		guiSetFont( buttonChangeSelectionColor, "default-bold-small" )
		
		labelHighlightColor = guiCreateLabel( 10, 213, 64, 12, "选中玩家颜色:", false, windowSettings )
		guiSetFont( labelHighlightColor, "default-small" )
		buttonChangeHighlightColor = guiCreateButton( 187, 213, 87, 14, "修改", false, windowSettings )
		guiSetFont( buttonChangeHighlightColor, "default-bold-small" )
		
		labelColumnHeaderColor = guiCreateLabel( 10, 230, 87, 12, "表头颜色:", false, windowSettings )
		guiSetFont( labelColumnHeaderColor, "default-small" )
		buttonChangeColumnHeaderColor = guiCreateButton( 187, 230, 87, 14, "修改", false, windowSettings )
		guiSetFont( buttonChangeColumnHeaderColor, "default-bold-small" )
		
		labelTeamHeaderColor = guiCreateLabel( 10, 247, 85, 12, "团队表头颜色:", false, windowSettings )
		guiSetFont( labelTeamHeaderColor, "default-small" )
		buttonChangeTeamHeaderColor = guiCreateButton( 187, 247, 87, 14, "修改", false, windowSettings )
		guiSetFont( buttonChangeTeamHeaderColor, "default-bold-small" )
		
		labelBorderlineColor = guiCreateLabel( 10, 264, 86, 12, "边框颜色:", false, windowSettings )
		guiSetFont( labelBorderlineColor, "default-small" )
		buttonChangeBorderlineColor = guiCreateButton( 187, 264, 87, 14, "修改", false, windowSettings )
		guiSetFont( buttonChangeBorderlineColor, "default-bold-small" )
		
		labelServerInfoColor = guiCreateLabel( 10, 281, 86, 12, "服务器信息颜色:", false, windowSettings )
		guiSetFont( labelServerInfoColor, "default-small" )
		buttonChangeServerInfoColor = guiCreateButton( 187, 281, 87, 14, "修改", false, windowSettings )
		guiSetFont( buttonChangeServerInfoColor, "default-bold-small" )
		
		labelContentColor = guiCreateLabel( 10, 298, 86, 12, "内容颜色:", false, windowSettings )
		guiSetFont( labelContentColor, "default-small" )
		buttonChangeContentColor = guiCreateButton( 187, 298, 87, 14, "修改", false, windowSettings )
		guiSetFont( buttonChangeContentColor, "default-bold-small" )
		
		buttonSaveChanges = guiCreateButton( 10, 322, 80, 15, "保存", false, windowSettings )
		guiSetFont( buttonSaveChanges, "default-small" )
		buttonRestoreDefaults = guiCreateButton( 95, 322, 80, 15, "恢复默认设置", false, windowSettings )
		guiSetFont( buttonRestoreDefaults, "default-small" )
		buttonCancel = guiCreateButton( 200, 322, 120, 15, "取消", false, windowSettings )
