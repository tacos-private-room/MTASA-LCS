...
addEventHandler('onClientPlayerJoin', root,
	function()
		...
		exports.lcs_ui:showTextBox('* ' .. getPlayerName(source) .. ' has joined the game',3000)
	end
)
...
addEventHandler('onClientPlayerChangeNick', root,
	function(oldNick, newNick)
		...
		exports.lcs_ui:showTextBox('* ' .. oldNick .. ' is now known as ' .. newNick,3000)
	end
)
...
addEventHandler('onClientPlayerQuit', root,
	function(reason)
		...
		exports.lcs_ui:showTextBox('* ' .. getPlayerName(source) .. ' has left the game [' .. reason .. ']',3000)
	end
)
