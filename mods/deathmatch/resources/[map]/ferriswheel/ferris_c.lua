...
local tstgs = {
  text = "按 '"..bdKey[ 1 ].."' 乘坐摩天轮",       -- Text that will show up when cabin gets closer to a player
  font = 'Arial',                                           -- Text font (can be a custom font too)
  scale = 1,                                                   -- Text scale
